...
//import com.hwl.chatbotapp.llm.ModelManager
//import java.util.*
//
...
//    }
//    // llm
////    private val modelManager = ModelManager(App.INSTANCE)
////
////    // LiveData to track ongoing model responses
////    val responseLiveData = MutableLiveData<String>()
////
////    fun generateModelResponse(prompt: String) {
////        modelManager.generateResponseAsync(prompt)
////        modelManager.collectResults(
////            onResult = { response ->
////                responseLiveData.postValue(response)
////            },
////            onError = { error ->
////                responseLiveData.postValue("Error: $error")
////            }
////        )
////    }
//}